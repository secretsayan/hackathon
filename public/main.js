...
module.exports = "html {\r\n  font-size: 16px;\r\n}\r\n\r\na{\r\n  text-decoration: none;\r\n}\r\n\r\na.active{\r\n  color: blue;\r\n  font-weight: bold;\r\n}\r\n\r\nng-sidebar-content,ng-sidebar-container,ng-sidebar{\r\n  height: 100vh;\r\n  font-size: 12px;\r\n}\r\n\r\n.header{\r\n  padding: 2vh;\r\n  text-align:center;\r\n}\r\n\r\n:host /deep/ .ng-sidebar--opened{\r\n  background-color: #337AB7;\r\n  padding: 3% 0 3% 3%;\r\n  color: white;\r\n  font-family: monospace;\r\n  height: 100vh;\r\n  font-size: 1.2em;\r\n  text-align: right;\r\n}\r\n\r\n:host /deep/ .ng-sidebar--opened .menu-links{\r\n  padding-right: 10px;\r\n}\r\n\r\n:host /deep/ ng-sidebar-container{\r\n  font-family: monospace;\r\n}\r\n\r\n.hamburger {\r\n  display: block;\r\n  position: relative;\r\n  overflow: hidden;\r\n  margin: 0;\r\n  padding: 0;\r\n  width: 96px;\r\n  height: 96px;\r\n  font-size: 0;\r\n  text-indent: -9999px;\r\n  cursor: pointer;\r\n  outline: none;\r\n  background: none;\r\n  border: 0;\r\n}\r\n\r\n.hamburger span {\r\n  display: block;\r\n  position: absolute;\r\n  top: 44px;\r\n  left: 18px;\r\n  right: 18px;\r\n  height: 8px;\r\n  background: #fff;\r\n}\r\n\r\n.hamburger span::before,\r\n.hamburger span::after {\r\n  display: block;\r\n  position: absolute;\r\n  left: 0;\r\n  width: 100%;\r\n  height: 8px;\r\n  background-color: #fff;\r\n  content: \"\";\r\n}\r\n\r\n.hamburger span::before {\r\n  top: -20px;\r\n}\r\n\r\n.hamburger span::after {\r\n  bottom: -20px;\r\n}\r\n\r\n:host /deep/ aside.ng-sidebar--closed{\r\n  background-color: #337AB7;\r\n  font-size: 32px;\r\n  color: #fff;\r\n  text-align: right;\r\n  padding: 0;\r\n}\r\n\r\n:host /deep/ aside.ng-sidebar--closed button.hamburger{\r\n  position: inherit;\r\n}\r\n\r\n:host /deep/ aside.ng-sidebar--closed span.hi{\r\n  display: none;\r\n}"
...
module.exports = "<ng-sidebar-container>\r\n\r\n\t<ng-sidebar [(opened)]=\"_opened\" mode=\"push\" id=\"sidebar\" dock=\"true\" dockedSize=\"60px\">\r\n\t\t<div class=\"button-div\">\r\n\t\t\t<button (click)=\"_toggleSidebar()\" class=\"hamburger\"><span>toggle</span></button>\r\n\t\t</div>\r\n\r\n\r\n\t\t<div class=\"menu-links\">\r\n\t\t\t<hr>\r\n\t\t\t<p routerLink=\"\" routerLinkActive=\"active\" [routerLinkActiveOptions]=\"{exact:true}\">Home <i\r\n\t\t\t\t\tclass=\"fa fa-home\" aria-hidden=\"true\" style=\"padding:0 20px 0 5px;\"></i></p>\r\n\t\t\t<span *ngIf='isLoggedIn'>\r\n\r\n\t\t\t\t<p routerLink=\"events\" routerLinkActive=\"active\" *ngIf='isLoggedIn'>\r\n\t\t\t\t\tDashboard <i class=\"fa fa-tachometer\" aria-hidden=\"true\" style=\"padding:0 20px 0 5px;\"></i>\r\n\t\t\t\t</p>\r\n\r\n\t\t\t\t<hr>\r\n\r\n\t\t\t\t<span class=\"hi\">Hi {{firstName}}!</span>\r\n\t\t\t\t<p (click)='logOut()'>\r\n\r\n\t\t\t\t\tLogout <i class=\"fa fa-sign-out\" aria-hidden=\"true\" style=\"padding:0 20px 0 5px;\"></i>\r\n\t\t\t\t</p>\r\n\t\t\t</span>\r\n\t\t\t<span *ngIf='!isLoggedIn'>\r\n\t\t\t\t<p routerLink=\"login\" routerLinkActive=\"active\" *ngIf='!isLoggedIn'>Login  <i class=\"fa fa-sign-in\"\r\n\t\t\t\t\t\taria-hidden=\"true\" style=\"padding:0 20px 0 5px;\"></i></p>\r\n\t\t\t\t<p routerLink=\"signup\" routerLinkActive=\"active\" *ngIf='!isLoggedIn'>\r\n\t\t\t\t\tSignUp   <i class=\"fa fa-user-plus\" aria-hidden=\"true\" style=\"padding:0 20px 0 5px;\"></i>\r\n\t\t\t\t</p>\r\n\t\t\t</span>\r\n\r\n\t\t</div>\r\n\r\n\t</ng-sidebar>\r\n\t<!-- Page content -->\r\n\t<div ng-sidebar-content>\r\n\t\t<div class=\"header\">\r\n\r\n\t\t\t<h1>Hackathon</h1>\r\n\t\t</div>\r\n\r\n\t\t<router-outlet></router-outlet>\r\n\r\n\r\n\t</div>\r\n\r\n\r\n</ng-sidebar-container>"
...
/* harmony import */ var _users_login_form_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./users/login-form.component */ "./src/app/users/login-form.component.ts");
/* harmony import */ var _users_adduser_form_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./users/adduser-form.component */ "./src/app/users/adduser-form.component.ts");
/* harmony import */ var _users_edituser_form_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./users/edituser-form.component */ "./src/app/users/edituser-form.component.ts");
...
/***/ "./src/app/events/addevent-form.component.html":
/*!*****************************************************!*\
  !*** ./src/app/events/addevent-form.component.html ***!
  \*****************************************************/
/*! no static exports found */
...
var AddEventFormComponent = /** @class */ (function () {
    function AddEventFormComponent(_eventService, router) {
        this._eventService = _eventService;
        this.router = router;
        this.title = "Adding an Event";
        this.statuses = ["Open", "In Progress", "Closed"];
    }
    AddEventFormComponent.prototype.onSubmit = function (formValue) {
        var _this = this;
        ...
        this._eventService.addEvent(newEvent).subscribe(function (val) {
...
/***/ "./src/app/events/editevent-form.component.html":
/*!******************************************************!*\
  !*** ./src/app/events/editevent-form.component.html ***!
  \******************************************************/
/*! no static exports found */
...
/***/ "./src/app/events/editevent-form.component.ts":
/*!****************************************************!*\
  !*** ./src/app/events/editevent-form.component.ts ***!
  \****************************************************/
...
var EditEventFormComponent = /** @class */ (function () {
    function EditEventFormComponent(_eventService, route, router) {
        this._eventService = _eventService;
        this.route = route;
        this.router = router;
    ...
    EditEventFormComponent.prototype.onSubmit = function (formValue) {
        ...
        this._eventService.updateEvent(updatedEvent).subscribe(function (val) {
            console.log(val);
            _this.router.navigate(['events']);
        });
    };
...
var EventComponent = /** @class */ (function () {
    function EventComponent(_eventService, route, location) {
        this._eventService = _eventService;
        this.route = route;
    ...
    EventComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./event.component.css */ "./src/app/events/event.component.css")]
        }),
        __metadata("design:paramtypes", [_events_service__WEBPACK_IMPORTED_MODULE_3__["EventsService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"]])
    ], EventComponent);
...
/***/ "./src/app/events/events-filter.pipe.ts":
/*!**********************************************!*\
  !*** ./src/app/events/events-filter.pipe.ts ***!
  \**********************************************/
...
var EventFilterPipe = /** @class */ (function () {
    ...
    EventFilterPipe = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"])({ name: 'eventFilter' })
    ], EventFilterPipe);
...
var EventsComponent = /** @class */ (function () {
    function EventsComponent(_userService, _eventService, router) {
        this._userService = _userService;
        this._eventService = _eventService;
        this.router = router;
    ...
    EventsComponent.prototype.deleteEvent = function (id) {
        var _this = this;
        this._eventService.deleteEvent(id).subscribe(function (data) { return _this.getEvents(); });
    };
    EventsComponent.prototype.stateChanged = function (e, id) {
        if (e.target.checked) {
    ...
    EventsComponent.prototype.bulkDelete = function () {
    ...
    EventsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_users_users_service__WEBPACK_IMPORTED_MODULE_1__["UsersService"], _events_service__WEBPACK_IMPORTED_MODULE_2__["EventsService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], EventsComponent);
...
/***/ "./src/app/users/adduser-form.component.ts":
/*!*************************************************!*\
  !*** ./src/app/users/adduser-form.component.ts ***!
  \*************************************************/
...
/***/ "./src/app/users/edituser-form.component.html":
/*!****************************************************!*\
  !*** ./src/app/users/edituser-form.component.html ***!
  \****************************************************/
/*! no static exports found */
...
module.exports = "<div class='panel panel-primary'>    \r\n\t<div class='panel-heading'>\r\n\t\t{{title}}\r\n\t</div>\r\n\t<div class='panel-body'>    \r\n\t\t<form #formRef=\"ngForm\" (ngSubmit)=\"onSubmit(formRef.value)\">\r\n\t\t\t<div class=\"form-group\">\r\n\t\t\t  <label for=\"email\">Email</label>\r\n\t\t\t  <input type=\"email\" class=\"form-control\" id=\"email\" name=\"email\" [(ngModel)]=\"user.email\" required minlength=\"5\" #nameRef=\"ngModel\">\r\n\t\t\t  <div *ngIf=\"nameRef.invalid && (nameRef.dirty || nameRef.touched)\" class=\"alert alert-danger\">\r\n\t\t\t\t<div *ngIf=\"nameRef.errors.required\">\r\n\t\t\t\t  Email is required.\r\n\t\t\t\t</div>\r\n\t\t\t\t<div *ngIf=\"nameRef.errors.minlength\">\r\n\t\t\t\t  Email must be at least 3 characters long.\r\n\t\t\t\t</div>\r\n\t\t\t  </div>\r\n\t\t\t</div>\r\n\t\t\t<div class=\"form-group\">\r\n\t\t\t  <label for=\"firstName\">First Name</label>\r\n\t\t\t  <input type=\"text\" class=\"form-control\" id=\"firstName\" name=\"firstName\" [(ngModel)]=\"user.firstName\" required minlength=\"3\" #descRef=\"ngModel\">\r\n\t\t\t  <div *ngIf=\"descRef.invalid && (descRef.dirty || descRef.touched)\" class=\"alert alert-danger\">\r\n\t\t\t\t<div *ngIf=\"descRef.errors.required\">\r\n\t\t\t\t  First Name is required.\r\n\t\t\t\t</div>\r\n\t\t\t\t<div *ngIf=\"descRef.errors.minlength\">\r\n\t\t\t\t  First Name must be at least 3 characters long.\r\n\t\t\t\t</div>\r\n\t\t\t  </div>\r\n\t\t\t</div>\r\n\t\t\t<div class=\"form-group\">\r\n\t\t\t  <label for=\"lastName\">Last Name</label>\r\n\t\t\t  <input type=\"text\" class=\"form-control\" id=\"lastName\" name=\"lastName\" [(ngModel)]=\"user.lastName\" required minlength=\"3\" #descRef2=\"ngModel\">\r\n\t\t\t  <div *ngIf=\"descRef2.invalid && (descRef2.dirty || descRef2.touched)\" class=\"alert alert-danger\">\r\n\t\t\t\t<div *ngIf=\"descRef2.errors.required\">\r\n\t\t\t\t  Last Name is required.\r\n\t\t\t\t</div>\r\n\t\t\t\t<div *ngIf=\"descRef2.errors.minlength\">\r\n\t\t\t\t  Last Name must be at least 3 characters long.\r\n\t\t\t\t</div>\r\n\t\t\t  </div>\r\n\t\t\t</div>\r\n\t\t\t<div class=\"form-group\">\r\n\t\t\t  <label for=\"password\">Password</label>\r\n\t\t\t  <input type=\"password\" class=\"form-control\" id=\"password\" name=\"password\" [(ngModel)]=\"user.password\" required minlength=\"5\" #passwordRef=\"ngModel\">\r\n\t\t\t  <div *ngIf=\"passwordRef.invalid && (passwordRef.dirty || passwordRef.touched)\" class=\"alert alert-danger\">\r\n\t\t\t\t<div *ngIf=\"passwordRef.errors.required\">\r\n\t\t\t\t  Password is required.\r\n\t\t\t\t</div>\r\n\t\t\t\t<div *ngIf=\"passwordRef.errors.minlength\">\r\n\t\t\t\t  Password must be at least 5 characters long.\r\n\t\t\t\t</div>\r\n\t\t\t  </div>\r\n\t\t\t</div>\r\n\t\t\t<div class=\"form-group\">\r\n\t\t\t  <label for=\"location\">Location</label>\r\n\t\t\t  <input type=\"text\" class=\"form-control\" id=\"location\" name=\"location\" [(ngModel)]=\"user.location\" required minlength=\"3\" #locationRef=\"ngModel\">\r\n\t\t\t  <div *ngIf=\"locationRef.invalid && (locationRef.dirty || locationRef.touched)\" class=\"alert alert-danger\">\r\n\t\t\t\t<div *ngIf=\"locationRef.errors.required\">\r\n\t\t\t\t  Location is required.\r\n\t\t\t\t</div>\r\n\t\t\t\t<div *ngIf=\"locationRef.errors.minlength\">\r\n\t\t\t\t  Location must be at least 3 characters long.\r\n\t\t\t\t</div>\r\n\t\t\t  </div>\r\n\t\t\t</div>\r\n\t\t\t<div class=\"form-group\">\r\n\t\t\t  <label for=\"mobile\">Mobile</label>\r\n\t\t\t  <input type=\"text\" class=\"form-control\" id=\"mobile\" name=\"mobile\" [(ngModel)]=\"user.mobile\" required minlength=\"10\" #mobileRef=\"ngModel\">\r\n\t\t\t  <div *ngIf=\"mobileRef.invalid && (mobileRef.dirty || mobileRef.touched)\" class=\"alert alert-danger\">\r\n\t\t\t\t<div *ngIf=\"mobileRef.errors.required\">\r\n\t\t\t\t  Mobile is required.\r\n\t\t\t\t</div>\r\n\t\t\t\t<div *ngIf=\"mobileRef.errors.minlength\">\r\n\t\t\t\t  Mobile must be at least 10 characters long.\r\n\t\t\t\t</div>\r\n\t\t\t  </div>\r\n\t\t\t</div>\r\n\t\t\t\r\n\t\t\t\r\n\t\t\t<button type=\"submit\" class=\"btn btn-info\" [disabled]=\"formRef.invalid\">Submit</button>\r\n\t\t\t\r\n\t\t</form>    \r\n\t</div>\r\n</div>"

/***/ }),

/***/ "./src/app/users/edituser-form.component.ts":
/*!**************************************************!*\
  !*** ./src/app/users/edituser-form.component.ts ***!
  \**************************************************/
...
var EditUserFormComponent = /** @class */ (function () {
    function EditUserFormComponent(_userService, route, router) {
        this._userService = _userService;
        this.route = route;
        this.router = router;
        this.title = "Editing an User";
        this.user = { firstName: "", lastName: "", email: "", password: "", location: "", mobile: "", role: "" };
    }
    EditUserFormComponent.prototype.ngOnInit = function () {
        ...
        this._userService.getMyProfile().subscribe(function (ev) { _this.user = ev; console.log(_this.user); });
    };
    EditUserFormComponent.prototype.onSubmit = function (formValue) {
        var _this = this;
        console.log("Form Value = " + JSON.stringify(formValue, null, 4));
        var updatedUser = {
            firstname: formValue.firstName,
        ...
        this._userService.updateUser(updatedUser).subscribe(function (val) {
            console.log(val);
            _this.router.navigate(['events']);
        });
    };
    EditUserFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./edituser-form.component.html */ "./src/app/users/edituser-form.component.html"),
            styles: ['.panel {margin:15px;}']
        }),
        __metadata("design:paramtypes", [_users_service__WEBPACK_IMPORTED_MODULE_2__["UsersService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]])
...
var LoginFormComponent = /** @class */ (function () {
    ...
    LoginFormComponent.prototype.stateChanged = function (e) {
        if (e.target.checked) {
            this.isAdmin = true;
        }
        else {
...
var UserComponent = /** @class */ (function () {
    ...
    UserComponent.prototype.ngOnInit = function () {
        ...
        this.user = this._userService.getUser(this.id).subscribe(function (user) { return _this.user = user; }, function (err) { return console.log(err); });
    };
    ...
    UserComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_users_service__WEBPACK_IMPORTED_MODULE_3__["UsersService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"]])
    ], UserComponent);
...
var UserFilterPipe = /** @class */ (function () {
    ...
    UserFilterPipe.prototype.transform = function (value, args) {
        ...
        return filter ? value.filter(function (user) {
            return user.name.toLocaleLowerCase().startsWith(filter) != false;
        }) : value;
    };
    UserFilterPipe = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"])({ name: 'userFilter' })
    ], UserFilterPipe);
...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.loginUser = function (userInfo, isAdmin) {
        var _this = this;
        var addUserURL = this._usersUrl + "/login";
        if (isAdmin) {
            addUserURL = this._usersUrl + "/admin/login";
        }
        return this._http.post(addUserURL, userInfo, this.httpOptions)
            .do(function (authResult) { return _this.setSession(authResult); })
            .shareReplay();
    };
    UsersService.prototype.getMyProfile = function () {
        var getUserURL = this._usersUrl + "/profile";
    ...
    UsersService.prototype.updateUser = function (updatedUser) {
        var updateUserURL = this._usersUrl + "/edit/" + updatedUser.id;
        return this._http.post(updateUserURL, updatedUser, this.httpOptions);
    };
    UsersService.prototype.deleteUser = function (id) {
        var deleteUserURL = this._usersUrl + "/delete/" + id;
...
module.exports = __webpack_require__(/*! F:\nodeReactUdemy+nodeangularworkspace\fullstack\hackathon\src\main.ts */"./src/main.ts");
